...
def build_tcn_dataset(full_df, attempt_id_col, time_col, sensor_cols, label_col, n_steps=N_STEPS):
...
def train_tcn_classifier(X, y):
	...
	model = TCNClassifier(num_inputs=X.shape[2], num_classes=num_classes).to(device)
...
if __name__ == "__main__":
	...
	sensor_cols = [
		...
		"gyro_x", "gyro_y", "gyro_z", "duration_seconds", "style_label", "topped_label", ## REMOVE  DURATION, STYLE AND TOPPED IF MODEL DOES NOT WORK 
	] + angle_sensor_cols
